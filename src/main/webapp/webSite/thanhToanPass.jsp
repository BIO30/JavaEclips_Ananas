        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary">
            <div class="container-fluid">
                ...
                <div class="text-center ms-5">
                    <a class="navbar-brand" href="trangChuServlet"><img style="width: 50%;"
                ...
                <div class="ms-2">
                    <a href="GioHangSVL" type="button" class="position-relative link-dark text-decoration-none">
                        <span class="fs-2 ">
...
<div class="container  " style="margin-top: 50px; margin-bottom: 100px;">
    <div class="">
        <h6 class=" m-2 text-secondary" style="padding-left: 50px; height: 40px; padding-top: 9px; background-color: gainsboro;">
            <strong><a href="GioHangSVL" class="text-decoration-none text-secondary">GIỎ HÀNG </a> <i class="bi bi-chevron-right"></i>
                <a href="tiepTucThanhToanServlet" class="text-decoration-none text-secondary">TIẾP TỤC THANH TOÁN </a>  <i class="bi bi-chevron-right"></i>
                <a href="thanhToanPassServlet" class="text-decoration-none text-secondary">hOÀN TẤT </a>
            </strong>
        </h6><br>
    </div>
    <div class="row text-center">
        ...
        <h5><strong>Cảm ơn bạn đã đặt hàng <br>
            Đơn hàng cuả bạn đang được xữ lý</strong></h5>
            <p>---------------------------------------------------------------------------------------------------</p>
            <h6><strong>THÔNG TIN MUA HÀNG</strong></h6>
            <p>
                Mã đơn hàng : <br>
                Tổng tiền : <br>
                Tên khách hàng : <br>
            ...
            <p>---------------------------------------------------------------------------------------------------</p>
            <div class="pb-5">
               <a href="sanPhamServlet" class="text-decoration-none">
                <button type="button" class="btn btn-outline-primary"><strong>Tiếp tục mua hàng</strong></button>
               </a>
            </div>
    </div>
</div>
